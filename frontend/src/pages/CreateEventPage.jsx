              ...
              <form onSubmit={handleCreateVenue} className="p-6 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className={`input w-full ${venueErrors.name ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                    placeholder="Enter venue name"
                  />
                  {venueErrors.name && (
                    <p className="mt-1 text-sm text-red-600">{venueErrors.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleVenueInputChange}
                    className={`input w-full ${venueErrors.address ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                    placeholder="Street address"
                  />
                  {venueErrors.address && (
                    <p className="mt-1 text-sm text-red-600">{venueErrors.address}</p>
                  )}
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleVenueInputChange}
                      className={`input w-full ${venueErrors.city ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                      placeholder="City"
                    />
                    {venueErrors.city && (
                      <p className="mt-1 text-sm text-red-600">{venueErrors.city}</p>
                    )}
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">
                    ...
                    <input
                      ...
                      onChange={handleVenueInputChange}
                      className={`input w-full ${venueErrors.state ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                      placeholder="State"
                    />
                    {venueErrors.state && (
                      <p className="mt-1 text-sm text-red-600">{venueErrors.state}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleVenueInputChange}
                    className={`input w-full ${venueErrors.zipCode ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                    placeholder="12345 or 12345-6789"
                  />
                  {venueErrors.zipCode && (
                    <p className="mt-1 text-sm text-red-600">{venueErrors.zipCode}</p>
                  )}
                </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleVenueInputChange}
                      className={`input w-full ${venueErrors.website ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : ''}`}
                      placeholder="https://example.com"
                    />
                    {venueErrors.website && (
                      <p className="mt-1 text-sm text-red-600">{venueErrors.website}</p>
                    )}
                  </div>
                </div>
